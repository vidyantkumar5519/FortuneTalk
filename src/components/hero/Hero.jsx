      ...
      >
        <div className="flex justify-between items-center h-full w-full flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-[70%] pb-8">
            <p
              className="text-[#F27806] mb-5"
              style={{ fontFamily: "Inter", fontSize: "21px" }}
            >
              Talk to Experienced and Verified Astrologers
            </p>
            <h3
              className="text-[#000]"
              style={{
            ...
            >
              Get first Free Consultation with Verified{" "}
              <span className="text-[#F27806]"> Astrologer </span>
            </h3>
          ...
          <div className="w-full sm:w-[30%] relative h-full">
            ...
            <div
              className="absolute top-0 left-1/2 h-[470px] w-[260px] sm:w-[260px] mt-[30px] bg-[#BFC9CD]"
              style={{
