...
/**
 * KundliMatching Component: Handles user input for generating Kundli and displays saved Kundlis.
 */
const KundliMatching = () => {
  ...
  return (
    <>
      <div className='flex flex-row justify-between bg-[#FFF9E7] px-20 py-14 '>
          ...
          <div className='bg-white p-8 shadow-xl rounded-3xl relative bottom-2'>
            ...
            {activeTab === 'generate' ? (
              ...
              <div className="space-y-4">
                ...
                <div className="relative flex flex-col gap-2 location-dropdown">
        ...
        <div>
          <img src={babaTillu} alt='babaTillu' className='ml-10'/>
        </div>
      </div>
    </>
  )
