...
import golGol from "../../assets/icons/golgol2.png";
import Rectangle from "../../assets/icons/Rectangle 65.png";
      ...
      >
        <div className="flex justify-between items-center h-full w-full flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-[70%] pb-8">
            ...
            >
              Chat with Astrologers for Free and get the Answers you Seek!
            </h3>
