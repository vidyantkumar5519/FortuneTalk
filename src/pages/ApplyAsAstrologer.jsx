...
const EditProfile = () => {
  return (
    <>
      ...
      <p className="text-[#9B9696] text-lg text-center mt-4">Please Fill the form, after you submit the form. Our team will reach you soon.</p>
      <div className="relative flex flex-col lg:flex-row w-full lg:w-4/5 mx-auto bg-[#E4E4E4] px-4  pt-10 pb-4 mt-6 mb-4 rounded-[10px]">
        ...
        <div className="w-full lg:w-1/2 lg:px-10">
          ...
          <div className="flex gap-8 my-6">
            <div className="w-full lg:w-3/4 mx-auto">
            <p className="text-lg text-[#9B9696] ml-10">Language</p>
          ...
          <div className="flex gap-8 my-6 items-center">
            <div className="w-full lg:w-3/4 mx-auto">
              <p className="text-lg text-[#9B9696] ml-10">Pincode</p>
            </div>
            <div className="w-full lg:w-3/4 mx-auto">
            <input
  type="number"
...
/>
          ...
          <div className="flex gap-8 my-6 items-center">
            <div className="w-full lg:w-3/4 mx-auto">
              <p className="text-lg text-[#9B9696] ml-10">Experience</p>
            </div>
            <div className="w-full lg:w-3/4 mx-auto">
              <select
                id="countries"
          ...
          <div className="flex gap-8 my-6 items-center">
            <div className="w-full lg:w-3/4 mx-auto">
              <p className="text-lg text-[#9B9696] ml-10">Expertise</p>
            </div>
            <div className="w-full lg:w-3/4 mx-auto">
              <select
                id="countries"
