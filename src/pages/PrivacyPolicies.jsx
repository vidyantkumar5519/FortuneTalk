    ...
    return (
        <>
            ...
            <div className='m-3 md:m-8 p-3 md:p-8  leading-7'>
                ...
                <p>
                <b> 8. Contact Us: </b> If you have any questions, concerns, or requests regarding your personal information or this Privacy Policy, please contact us at contact@fortunetalk.co.in..
                </p>
                <br />
            ...
            {/* <div className='mt-12 flex'>
                <h2 className='text-[#F17806] mx-auto justify-center text-[42px] leading-10 px-4 sm:px-8'>
                    Fortune Talk Privacy Policy
                </h2>
            </div>
            <div className='m-3 md:m-8 p-3 md:p-8  leading-7'>
                <p>Welcome to Fortune Talk, an astrology company dedicated to providing personalized astrological insights and guidance. This Privacy Policy outlines how we collect, use, disclose, and protect the personal information of our users. By accessing or using our services, you agree to the terms described in this policy.</p>
                <br />
                <p>
                    <b>1. Information We Collect:</b> We collect the following types of information to provide and improve our services:
                    Personal Information: When you create an account, we may collect your name, email address, date of birth, and other relevant personal details.
                    Birth Information: To provide accurate astrological insights, we collect information about your date, time, and place of birth.
                    Usage Data: We may collect information about how you interact with our website and services, including log data, device information, and usage patterns.
                </p>
                <br />

                <p>
                    <b>2. How We Use Your Information:</b><br /> We use your information for the following purposes: <br />
                    Astrological Services: We use your birth information to generate personalized astrological readings, horoscopes, and guidance.<br />
                    Communication: We may use your email address to send you updates, newsletters, and information about our services. You can opt out of these communications at any time.<br />
                    Improvement: We analyze usage data to improve our services, user experience, and develop new features.<br />
                    Customer Support: Your information helps us assist you effectively when you reach out to our customer support team.
                </p>
                <br />
                ...
                <br />
                <p>
                    <b>4. Data Sharing and Disclosure:</b> We do not sell, rent, or trade your personal information to third parties. However, we may share your information in the following cases: Service Providers: We may share information with trusted service providers who assist us in delivering our services, but only for the purposes outlined in this policy.
                    Legal Requirements: We may disclose your information if required by law, subpoena, or other legal processes.
                </p>
                <br />
                <p>
                    <b>5. Your Choices:</b>
                    Account Settings: You can review and update your account information at any time by logging into your account.
                    Opting Out: You can unsubscribe from our marketing communications by following the instructions in the emails we send you.
                    Cookies: You can manage your cookie preferences through your browser settings.</p>
                <br />
                <p>
                    <b>6. Children's Privacy:</b>
                    Our services are not intended for children under the age of 13. We do not knowingly collect personal information from children. If you are a parent or guardian and believe your child has provided us with personal information, please contact us to have it removed.</p>
                <br />

                <p>
                    <b>7. Changes to this Privacy Policy:</b>
                    We may update this Privacy Policy from time to time. We will notify you of significant changes through email or by posting a notice on our website. Your continued use of our services after the changes means you accept the updated policy. </p>
                <br />
                ...
                <p>
                    ...
                    <span>  <a href="mailto:contact@fortunetalk.co.in." className="text-blue-500 underline">contact@fortunetalk.co.in.</a>.</span>
                </p>
                <br />

                <p>
                    By using Fortune Talk's services, you agree to the terms outlined in this Privacy Policy. Thank you for entrusting us with your astrological journey. </p>
                <br />
